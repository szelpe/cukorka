CREATE TABLE aid (id INT AUTO_INCREMENT, course_id INT NOT NULL, uploader_id INT NOT NULL, filename VARCHAR(128) NOT NULL, date DATETIME NOT NULL, INDEX course_id_idx (course_id), INDEX uploader_id_idx (uploader_id), PRIMARY KEY(id)) ENGINE = INNODB;
