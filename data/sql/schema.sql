...
CREATE TABLE course (id INT AUTO_INCREMENT, url VARCHAR(128) NOT NULL UNIQUE, title VARCHAR(128) NOT NULL, description text NOT NULL, check_in_text text NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE homework (uploader_id INT NOT NULL, lecture_id INT NOT NULL, file VARCHAR(128) NOT NULL, date DATETIME NOT NULL, id INT AUTO_INCREMENT, rate INT, comment VARCHAR(128), INDEX lecture_id_idx (lecture_id), INDEX uploader_id_idx (uploader_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE sf_guard_user (id INT AUTO_INCREMENT, username VARCHAR(128) NOT NULL UNIQUE, algorithm VARCHAR(128) DEFAULT 'sha1' NOT NULL, salt VARCHAR(128), password VARCHAR(128), is_active TINYINT(1) DEFAULT '1', is_super_admin TINYINT(1) DEFAULT '0', last_login DATETIME, is_schacc TINYINT(1), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX is_active_idx_idx (is_active), PRIMARY KEY(id)) ENGINE = INNODB;
