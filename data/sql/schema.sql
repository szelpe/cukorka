...
CREATE TABLE homework (uploader_id INT NOT NULL, lecture_id INT NOT NULL, file VARCHAR(128) NOT NULL, date DATETIME NOT NULL, id INT AUTO_INCREMENT, rate INT, INDEX lecture_id_idx (lecture_id), INDEX uploader_id_idx (uploader_id), PRIMARY KEY(id)) ENGINE = INNODB;
