...
abstract class BaseHomeworkForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'uploader_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('User'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'uploader_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('User'))),
